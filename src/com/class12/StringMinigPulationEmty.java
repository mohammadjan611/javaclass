...
public class StringMinigPulationEmty {

	public static void main(String[] args) {
// this method checks whether a string is empty or not . this method return if the given string is 
...
//        }
        ...
        String sentence="Each day has a promise to brighten up the day,\nBut first you"
        		+ " must allow the sun to come your way";
